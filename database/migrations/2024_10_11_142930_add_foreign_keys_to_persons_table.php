...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('persons', function (Blueprint $table) {
            ...
            $table->foreign(['person_telephone_id'], 'persons_ibfk_5')->references(['id'])->on('person_types')->onUpdate('no action')->onDelete('no action');
            $table->foreign(['person_subtype_id'], 'persons_ibfk_6')->references(['id'])->on('person_type_subtypes')->onUpdate('no action')->onDelete('no action');
        });
    }
