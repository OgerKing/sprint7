<div
    id="defendant-document-management-form"
...
>
    ...
    <form wire:submit.prevent="save">
        ...
        <div class="row">
            ...
            <div>
                <div class="card doc-management-defendant">
                    <div class="card-body row">
                        <div
                            class="col-md-5 doc-management-defendant-form-column"
                        >
                            <div>
                                <div id="defendant-document-form">
                                    <div class="row card-columns">
                                        <div
                                            class="col-md-12 defendant-document-columns"
                                        >
                                            <div>
                                                <div class="my-4">
                                                    <x-wrats-basic-text-input
                                                        ...
                                                        id="dd-title"
                                                        :disabled="!$isEditable"
                                                        wire:model="form.document_title"
                                                        tooltipContent="{{ config('tooltip-config.defendant_documents.defendant_document_title') }}"
                                                    />
                                                    @error('form.document_title')
                                                        <span
                ...
                $('#datePickerDefendant').val(''); // Leave empty if there's no date
                                                ...
                                                <div class="my-4">
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            Document Type
                                                            <x-wrats-tooltip
                                                                tooltipContent="{{ config('tooltip-config.defendant_documents.defendant_document_type_id') }}"
                                                            />
                                                        </div>
                                                        <select
                                                ...
                                                <div class="my-4">
                                                    <x-wrats-basic-text-input
                                                        ...
                                                        maxLength="10"
                                                        tooltipContent="{{ config('tooltip-config.defendant_documents.docket_id') }}"
                                                    />
